...
print("=== Patching Android project (v3.2) ===")
...
activity_dir = "android/app/src/main/java/com/webtoapp/appn0m69y"
for f in glob.glob("android/app/src/main/java/**/MainActivity.*", recursive=True):
    os.remove(f)
    print("Removed: " + f)
os.makedirs(activity_dir, exist_ok=True)

MAINACTIVITY_JAVA = r"""package com.webtoapp.appn0m69y;
...
if os.path.exists(ma_path):
    ...
    expected_pkg = "package " + "com.webtoapp.appn0m69y" + ";"
